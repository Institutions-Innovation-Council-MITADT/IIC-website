...
const About = () => {
  ...
  return (
    <div className="relative bg-white w-full min-h-screen text-center text-[0.7rem] lg:text-[1.7rem] text-black font-source-sans-pro">
      ...
      />
      <img className="last_one" alt="Text" src="/lastpage.png" />
        ...
        <div className="foot-content">
          ...
          <div className="box3">
            ...
            <div className="contact">
              <div className="box4">
                <b>Address :</b> New IT Building, N-602, MIT ADT University,
                Rajbaugh, Solapur - Pune Hwy, near Bharat Petrol Pump, Loni
